...
export const appRoutes: Route[] = [
  ...
  // CartFacade and WishlistFacade are NOT provided here — both are
  // providedIn: 'root' (see storefront-data-access) precisely because
  // multiple routes need to share the same instance. See cart.facade.ts.
